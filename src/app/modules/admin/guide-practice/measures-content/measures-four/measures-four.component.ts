...
@Component({
  selector: 'measures-four',
  standalone: false,
  templateUrl: './measures-four.component.html',
  styleUrl: './measures-four.component.scss'
})
export class MeasuresFourComponent {
    @Input() data: ProjectInfoResModel;
    @Output() dataChange: EventEmitter<ProjectInfoResModel> = new EventEmitter();
    measuresPrefix: string = 'TOR'
