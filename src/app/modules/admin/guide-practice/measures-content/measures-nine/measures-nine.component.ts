...
@Component({
  selector: 'measures-nine',
  standalone: false,
  templateUrl: './measures-nine.component.html',
  styleUrl: './measures-nine.component.scss'
})
export class MeasuresNineComponent {
  @Input() data: ProjectInfoResModel;
  @Output() dataChange: EventEmitter<ProjectInfoResModel> = new EventEmitter();
  measuresPrefix: string = 'Acceptance_Work'
