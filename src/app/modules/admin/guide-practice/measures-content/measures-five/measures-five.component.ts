...
@Component({
  selector: 'measures-five',
  standalone: false,
  templateUrl: './measures-five.component.html',
  styleUrl: './measures-five.component.scss'
})
export class MeasuresFiveComponent {
  @Input() data: ProjectInfoResModel;
  @Output() dataChange: EventEmitter<ProjectInfoResModel> = new EventEmitter();
  measuresPrefix: string = 'Anti_Offer_Price'
