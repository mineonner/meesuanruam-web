...
@Component({
  selector: 'measures-two',
  standalone: false,
  templateUrl: './measures-two.component.html',
  styleUrl: './measures-two.component.scss'
})
export class MeasuresTwoComponent {
@Input() data: ProjectInfoResModel;
  @Output() dataChange: EventEmitter<ProjectInfoResModel> = new EventEmitter();
  measuresPrefix: string = 'Human_Resources'
  ...
  acthievementData: { [key: string]: string } = {
    ...
    [`${this.measuresPrefix}_Acthievement_2`] : '0'
  }
