...
@Component({
  selector: 'measures-eleven',
  standalone: false,
  templateUrl: './measures-eleven.component.html',
  styleUrl: './measures-eleven.component.scss'
})
export class MeasuresElevenComponent {
  @Input() data: ProjectInfoResModel;
  @Output() dataChange: EventEmitter<ProjectInfoResModel> = new EventEmitter();
  measuresPrefix: string = 'Prevention_Bribe'
