...
@Component({
  selector: 'measures-eight',
  standalone: false,
  templateUrl: './measures-eight.component.html',
  styleUrl: './measures-eight.component.scss'
})
export class MeasuresEightComponent {
  @Input() data: ProjectInfoResModel;
  @Output() dataChange: EventEmitter<ProjectInfoResModel> = new EventEmitter();
  measuresPrefix: string = 'Disbursement_Report'
