...
@Component({
  selector: 'measures-twelve',
  standalone: false,
  templateUrl: './measures-twelve.component.html',
  styleUrl: './measures-twelve.component.scss'
})
export class MeasuresTwelveComponent {
  @Input() data: ProjectInfoResModel;
  @Output() dataChange: EventEmitter<ProjectInfoResModel> = new EventEmitter();
  measuresPrefix: string = 'Amend_Prevention'
