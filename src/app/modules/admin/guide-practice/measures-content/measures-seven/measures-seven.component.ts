...
@Component({
  selector: 'measures-seven',
  standalone: false,
  templateUrl: './measures-seven.component.html',
  styleUrl: './measures-seven.component.scss'
})
export class MeasuresSevenComponent {
  @Input() data: ProjectInfoResModel;
  @Output() dataChange: EventEmitter<ProjectInfoResModel> = new EventEmitter();
  measuresPrefix: string = 'Examine'
