...
@Component({
  selector: 'measures-one',
  standalone: false,
  templateUrl: './measures-one.component.html',
  styleUrl: './measures-one.component.scss'
})
export class MeasuresOneComponent {
  @Input() data: ProjectInfoResModel;
  @Output() dataChange: EventEmitter<ProjectInfoResModel> = new EventEmitter();
  measuresPrefix: string = 'Policy'
